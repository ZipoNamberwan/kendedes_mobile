...
class MoveSidebarWidget extends StatefulWidget {
  const MoveSidebarWidget({super.key});

  @override
  State<MoveSidebarWidget> createState() => _MoveSidebarWidgetState();
}

class _MoveSidebarWidgetState extends State<MoveSidebarWidget> {
    ...
    return BlocConsumer<MoveBloc, MoveState>(
      ...
      builder: (context, state) {
        return AnimatedPositioned(
          ...
          top: 0,
          right: state.data.isMoveSideBarOpen ? 0 : -300,
          bottom: 0,
          width: 300,
          child: Stack(
            children: [
                      ...
                      child: Row(
                        children: [
                          ...
                          if (state.data.isBusinessFilterActive())
                            InkWell(
                              onTap: () => _moveBloc.add(ResetAllFilter()),
                              borderRadius: BorderRadius.circular(10),
                              child: Container(
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return BusinessListItemWidget(
                                ...
                                onTap: () {
                                  _moveBloc.add(SelectBusiness(business));
                                },
                              );
                            },
                          );
                  ...
                  child: AnimatedOpacity(
                    ...
                    child: Center(
                      child: GestureDetector(
                        onTap:
                            () => _moveBloc.add(SetMoveSideBarOpen(false)),
                        child: Container(
                          padding: const EdgeInsets.symmetric(
                            horizontal: 16,
                            vertical: 8,

...
class TaggingSidebarWidget extends StatefulWidget {
  const TaggingSidebarWidget({super.key});

  @override
  State<TaggingSidebarWidget> createState() => _TaggingSidebarWidgetState();
}

class _TaggingSidebarWidgetState extends State<TaggingSidebarWidget> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<TaggingBloc, TaggingState>(
      listener: (context, state) {
        if (state is TaggingSideBarOpened ||
      ...
      builder: (context, state) {
        return AnimatedPositioned(
          ...
          top: 0,
          right: state.data.isTaggingSideBarOpen ? 0 : -300,
          bottom: 0,
          width: 300,
          child: Container(
